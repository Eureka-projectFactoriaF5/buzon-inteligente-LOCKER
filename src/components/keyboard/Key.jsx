...
export const Key = ({ type, value, onPress, isActive }) => {
  ...
  return (
    <button
      onClick={onPress}
      className={`
    w-full h-[85%] m-[1%] flex justify-center items-center
    rounded-[8%] text-[#0c1991] text-2xl font-bold cursor-pointer
    font-[bree-serif] transition-colors duration-150 ease-in-out
